//constructor for a bike-pole (= device) ->                    LATER TO CONTROL INTO DB THE EXISTING TABLES !!!!
/*
...
history: {
  ...
  hour: 0-23
  count: n°,
  AVG_hour_speed: n°,xx   float rounded by two numbers after the decimal point
}
*/
